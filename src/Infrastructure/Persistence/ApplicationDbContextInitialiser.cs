...
public class ApplicationDbContextInitialiser
{
    ...
    public async Task TrySeedAsync()
    {
        ...
        //{
        //    _context.Products.Add(new Domain.Entities.Product() {CreatedBy=administrator.Id, Brand = "Apple", Name = "IPhone 13 Pro", Description = "Apple iPhone 13 Pro smartphone. Announced Sep 2021. Features 6.1″ display, Apple A15 Bionic chipset, 3095 mAh battery, 1024 GB storage.", Unit = "EA", Price = 999.98m });
        //    _context.Products.Add(new Domain.Entities.Product() { CreatedBy = administrator.Id, Brand = "MI", Name = "MI 12 Pro", Description = "Xiaomi 12 Pro Android smartphone. Announced Dec 2021. Features 6.73″ display, Snapdragon 8 Gen 1 chipset, 4600 mAh battery, 256 GB storage.", Unit = "EA", Price = 199.00m });
        //    _context.Products.Add(new Domain.Entities.Product() { CreatedBy = administrator.Id, Brand = "Logitech", Name = "MX KEYS Mini", Description = "Logitech MX Keys Mini Introducing MX Keys Mini – a smaller, smarter, and mightier keyboard made for creators. Type with confidence on a keyboard crafted for efficiency, stability, and...", Unit = "PA", Price = 99.90m });
        //    await _context.SaveChangesAsync();
        //}
    }
}
