...
namespace CleanArchitecture.Blazor.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220326080910_Paid_Cash")]
    partial class Paid_Cash
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.CostDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.GoodsDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.ShippingOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Truck", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.CostDetail", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.ShippingOrder", "ShippingOrder")
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.ShippingOrder", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Truck", "Truck")
                        .WithMany()
